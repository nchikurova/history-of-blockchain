...
!(function (t, n) {
  ...
  function T(t, n, r) {
    var e = (n - t) / Math.max(0, r),
      ...
      f = e / Math.pow(10, o);
    return o >= 0
      ? (f >= b ? 10 : f >= A ? 5 : f >= x ? 2 : 1) * Math.pow(10, o)
      : -Math.pow(10, -o) / (f >= b ? 10 : f >= A ? 5 : f >= x ? 2 : 1);
  }
  function E(t, n, r) {
    let e;
    for (;;) {
  ...
  function _() {
    ...
    function e(e) {
      ...
      Array.isArray(h) ||
        ((h = +h),
        n === p && ([a, s] = E(a, s, h)),
        (h = S(a, s, h))[h.length - 1] === s && h.pop());
      for (var d = h.length; h[0] <= a; ) h.shift(), --d;
      for (; h[d - 1] > s; ) h.pop(), --d;
      var y,
        v = new Array(d + 1);
      for (o = 0; o <= d; ++o)
        ((y = v[o] = []).x0 = o > 0 ? h[o - 1] : a), (y.x1 = o < d ? h[o] : s);
      for (o = 0; o < u; ++o)
        a <= (i = l[o]) && i <= s && v[f(h, i, 0, d)].push(e[o]);
      return v;
    }
    return (
      (e.value = function (n) {
        return arguments.length
          ? ((t = 'function' == typeof n ? n : w(n)), e)
          : t;
      }),
      (e.domain = function (t) {
        return arguments.length
          ? ((n = 'function' == typeof t ? t : w([t[0], t[1]])), e)
          : n;
      }),
  ...
  function k(t, r, e = 0, o = t.length - 1, f = n) {
    for (; o > e; ) {
      if (o - e > 600) {
        const n = o - e + 1,
          i = r - e + 1,
          ...
          c = 0.5 * Math.sqrt((u * l * (n - l)) / n) * (i - n / 2 < 0 ? -1 : 1);
        k(
          t,
          r,
          Math.max(e, Math.floor(r - (i * l) / n + c)),
          Math.min(o, Math.floor(r + ((n - i) * l) / n + c)),
          f
        );
      }
      const n = t[r];
      let i = e,
        u = o;
      for (F(t, e, r), f(t[o], n) > 0 && F(t, e, o); i < u; ) {
        for (F(t, i, u), ++i, --u; f(t[i], n) < 0; ) ++i;
        for (; f(t[u], n) > 0; ) --u;
      }
      0 === f(t[e], n) ? F(t, e, u) : (++u, F(t, u, o)),
        u <= r && (e = u + 1),
        r <= u && (o = u - 1);
    }
    return t;
  ...
  function I(t, n, r) {
    if (
      ...
      if ((n = +n) <= 0 || e < 2) return j(t);
      if (n >= 1) return q(t);
      var e,
        o = (e - 1) * n,
        f = Math.floor(o),
        i = q(k(t, f).subarray(0, f + 1));
      return i + (j(t.subarray(f + 1)) - i) * (o - f);
    }
  }
  function L(t, n) {
    let r,
  ...
  function R(t) {
    ...
    for (var n = -1, r = j(t, B), e = new Array(r); ++n < r; )
  ...
  (t.Adder = y),
    ...
    (t.quantile = I),
    (t.quantileSorted = function (t, n, r = e) {
      if ((o = t.length)) {
    ...
    (t.rollup = function (t, n, ...r) {
      return M(t, v, n, r);
    }),
    (t.rollups = function (t, n, ...r) {
    ...
    (t.sort = function (t, r = n) {
      if ('function' != typeof t[Symbol.iterator])
        throw new TypeError('values is not iterable');
      return Array.from(t).sort(r);
    }),
